...
nama='$nama',jenkel='$jenkel',kelas='$kelas',jurusan='$jurusan' WHERE
...
nama='$nama',jenkel='$jenkel',kelas='$kelas',jurusan='$jurusan',photo='$n
...
PERBOLEHKAN');window.location='editmahasiswa.php?id=$npm';</script>";
}
}
}
?>
